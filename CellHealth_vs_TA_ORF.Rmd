...
cm <- get_correlation_matrix(df_cell_health, df_ta_orf, "ATF4")
corrplot(cm,title = "ATF4", diag = FALSE, mar = c(0,0,1,0))
hc <- hclust(dist(cm))
...
corrplot(cor_matrix,title = "22 collapsed genes", diag = FALSE, mar = c(0,0,1,0))
...
#position <- rep(c(1:22),each = 6)
#color_list <- rep(c(1:6),22)
...
corrplot(cm, diag = FALSE, title = common_genes$Metadata_gene_name[22], mar = c(0,0,1,0))
