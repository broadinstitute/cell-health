...
file_name_common_genes_collapsed <- '../../backend/CRISPR_PILOT_B1/CRISPR_TAORF_common_genes_collapsed_normalized_variable_selected.txt'
file_name_common_genes <- '../../backend/CRISPR_PILOT_B1/CRISPR_TAORF_common_genes_normalized_variable_selected.txt'
...
cm <- get_correlation_matrix(df_cell_health, df_ta_orf, common_genes$Metadata_gene_name)
corrplot(cm,title = "common genes", diag = TRUE, mar = c(0,0,1,0))
hc <- hclust(dist(cm))
plot(as.phylo(hc), type = "fan",  label.offset = 0.3)

df <- df <- combine_matrices(df_cell_health, df_ta_orf, common_genes)
